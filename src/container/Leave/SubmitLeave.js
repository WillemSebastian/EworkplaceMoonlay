...
import { Item, Form, Icon, DatePicker, Input, Content } from "native-base";
import Metrix from "../../components/Utility/Metrix";
import BottomSubmitLeave2Button from "../../components/UI/Button/BottomSubmitLeave2Button";
  ...
  render() {
    return (
      <View style={{ backgroundColor: "white", flex: 1 }}>
        ...
        <BottomSubmitLeave2Button SuccessText="Submitted" />
        <FooterApp />
      </View>
    );
  }
