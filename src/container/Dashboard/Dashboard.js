...
import { StyleSheet, Text, View, KeyboardAvoidingView, TextInput, Button, Image, ImageBackground } from 'react-native'
                  ...
                  <CardItem style={styles.Box}>
                    <Body style={styles.CardProfileContent}>
                      ...
                      <View style = {{flexDirection: 'row', marginTop: 20}}>
                        <Image  
                        style = {{borderColor: 'red', height: 25, width: 20}}
                        source = {location} />
                        <Text style={{ fontWeight: 'bold', fontSize: 15, marginLeft: 10, color: 'blue'}}>
                          Work From Home
                        </Text>
                      </View>
                    </Body>
